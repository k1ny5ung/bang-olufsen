...
Write between 05-10 high-value test scenarios for this feature:
	...
	- Verify that mode switching is blocked and a notification message is displayed when the earbud battery is below 5%.(Test cases: Left/Right at ≥5% and <5% respectively).
